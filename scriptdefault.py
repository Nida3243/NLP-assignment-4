...
# '''
# prompt ='''You are a validation expert for schematics. Your task is to verify whether the colors assigned to the borders of all wires in the schematic are correct according to the following list:
...
# Here are some example wire codes you need to validate:

# 4140D
# 4263E
# 6715A
# For each wire code, output the results in the following format:

# Example Output:

# 6571 (Border Color):
# Last digit: 1
# Expected border color: Brown
# Actual border color: Brown
# Status: Correct
# You must ensure that every wire present in the schematic is validated. After validating all wire codes, provide a summary of any wires that have incorrect border colors according to the provided list in the following format:

# Summary of Incorrect Border Colors:

# 0002 (Border Color should be Green) but is Red.
# 0001 (Border Color should be Black) but is Brown.
# 6506 (Border Color should be Blue) but is Yellow.
# Ensure that you do not miss any wires in your validation process.
